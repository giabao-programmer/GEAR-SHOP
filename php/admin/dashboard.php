...
$get_order = "select * from orderdetails order by 1 DESC LIMIT 0,5";
...
$unitprice = $row_order['unitprice'];

$qty = $row_order['quantity'];

$order_status = $row_order['unitprice'];
...
$get_customers = "select * from orders where orderId='$order_id'";

$run_customers = mysqli_query($con,$get_customers);

$row_customers = mysqli_fetch_array($run_customers);

$o_name = $row_customers['cus_name'];
