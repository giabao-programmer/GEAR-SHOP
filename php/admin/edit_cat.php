...
$edit_cat = "select * from category where categoryId='$edit_id'";

$run_edit = mysqli_query($con,$edit_cat);

$row_edit = mysqli_fetch_array($run_edit);

$c_id = $row_edit['categoryId'];

$c_name = $row_edit['categoryName'];

$c_image = $row_edit['CateImage'];

$new_c_image = $row_edit['CateImage'];
...
<input type="text" name="categoryName" class="form-control" value="<?php echo $c_name; ?>">
...
<input type="file" name="CateImage" class="form-control">
...
$cat_image = $_FILES['CateImage']['name'];

$temp_name = $_FILES['CateImage']['tmp_name'];
...
$update_cat = "update category set categoryName='$cat_name',cat_image='$cat_image' where categoryId='$c_id'";
